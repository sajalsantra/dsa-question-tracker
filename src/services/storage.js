 ...
 * Ported from: js/storage.js
 * Provides localStorage helpers, Firestore DB wrappers, auth lifecycle, debounced saves
 */
...
import { STORAGE_KEYS as K } from '../utils/constants.js';
...
/**
 * Resolve user profile name with graceful fallbacks
...
// Debounce helper for rapid save requests
const debouncers = {};
...
// One-Time Safe Migration from LocalStorage to Cloud Firestore
