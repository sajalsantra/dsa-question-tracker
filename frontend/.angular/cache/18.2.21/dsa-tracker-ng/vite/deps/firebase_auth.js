  ...
  _initializeWithPersistence(persistenceHierarchy, popupRedirectResolver) {
    ...
    this._initializationPromise = this.queue(() => __async(this, null, function* () {
      ...
      try {
        ...
        this.persistenceManager = yield PersistenceUserManager.create(this, []);
      } finally {
      ...
      try {
        ...
        yield this.directlySetCurrentUser(null).catch(() => {
        });
      }
  ...
  directlySetCurrentUser(user) {
    return __async(this, null, function* () {
      ...
      if (this.persistenceManager) {
        try {
          if (user) {
            yield this.persistenceManager.setCurrentUser(user);
          } else {
            yield this.persistenceManager.removeCurrentUser();
          }
        } catch (e) {
...
var RecaptchaEnterpriseVerifier = class _RecaptchaEnterpriseVerifier {
  ...
  verify(action = "verify", forceRefresh = false) {
    return __async(this, null, function* () {
      ...
      return new Promise((resolve, reject) => {
        retrieveSiteKey(this.auth).then((siteKey) => __async(this, null, function* () {
          ...
          _RecaptchaEnterpriseVerifier.scriptInjectionDeferred) {
            yield _RecaptchaEnterpriseVerifier.scriptInjectionDeferred.promise;
