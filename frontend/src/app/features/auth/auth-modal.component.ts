...
@Component({
  ...
  template: `
    @if (authModalService.isOpen()) {
      <div class="modal-overlay" (click)="authModalService.close()">
        <div class="modal-card auth-modal" (click)="$event.stopPropagation()">

          <!-- Modal Header -->
          <div class="auth-header">
            <button class="close-btn" (click)="authModalService.close()" title="Close dialog">✕</button>
          ...
          @if (isForgotPassword) {
            ...
            <div class="social-buttons">
              ...
              <button type="button" class="btn btn-social" (click)="loginWithGithub()">
...
export class AuthModalComponent {
  ...
  loginWithGithub(): void {
    this.authService.loginWithGithub().subscribe({
      ...
      error: (err) => this.toast.show(err.message || 'GitHub Sign-In failed', 'error')
    });
  }
  ...
  sendPasswordReset(): void {
    ...
    this.authService.sendPasswordResetEmail(this.resetEmail).subscribe({
      ...
      error: (err) => this.toast.show(err.message || 'Failed to send reset link', 'error')
    });
  }
